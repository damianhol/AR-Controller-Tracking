...
* @coauthor AntonioRitucci / https://github.com/AntonioRitucci
...
class ARButton{
    ...
    button.style.display = 'none';
                ...
                // Modified by Antonio Ritucci
    
    navigator.xr.isSessionSupported( 'immersive-ar' ).then( ( supported ) => {
    
    
    supported ? this.tryStartAR( button ) : this.showARNotSupported( button );
    ...
    this.stylizeElement( message, false );
        ...
        tryStartAR( button ) {
            ...
            if (this.androidV() < 10) {
                    ...
                    alert("You'r android version is " + this.androidV());
